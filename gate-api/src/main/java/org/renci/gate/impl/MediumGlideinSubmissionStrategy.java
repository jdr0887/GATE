...
public class MediumGlideinSubmissionStrategy extends AbstractGlideinSubmissionStrategy {

    private final Logger logger = LoggerFactory.getLogger(MediumGlideinSubmissionStrategy.class);

    public MediumGlideinSubmissionStrategy() {
        super();
    }
