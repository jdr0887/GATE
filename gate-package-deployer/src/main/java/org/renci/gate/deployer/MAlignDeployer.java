 ...
 * 
 */
@Package(name = "MAlign", version = "2.7")
public class MAlignDeployer extends AbstractCLDeployer {

    /**
     * 
     */
    public MAlignDeployer() {
        super();
    }
    ...
    protected String getVersion() {
        return MAlignDeployer.class.getAnnotation(Package.class).version();
    }
    ...
    protected String getPackageName() {
        return MAlignDeployer.class.getAnnotation(Package.class).name();
    }
    ...
    protected String getArchiveTemplate() {
        return MAlignDeployer.class.getAnnotation(Package.class).archiveNameTemplate();
    }
    ...
    protected String getSourceURL() {
        return MAlignDeployer.class.getAnnotation(Package.class).sourceURL();
    }
