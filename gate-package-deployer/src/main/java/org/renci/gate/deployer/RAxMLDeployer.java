 ...
 * 
 */
@Package(name = "RAxML", version = "7.0.4", archiveNameTemplate = "${packageName}-${version}.tar.gz")
public class RAxMLDeployer extends AbstractCLDeployer {
    ...
    protected String getVersion() {
        return RAxMLDeployer.class.getAnnotation(Package.class).version();
    }
    ...
    protected String getPackageName() {
        return RAxMLDeployer.class.getAnnotation(Package.class).name();
    }
    ...
    protected String getArchiveTemplate() {
        return RAxMLDeployer.class.getAnnotation(Package.class).archiveNameTemplate();
    }
    ...
    protected String getSourceURL() {
        return RAxMLDeployer.class.getAnnotation(Package.class).sourceURL();
    }
