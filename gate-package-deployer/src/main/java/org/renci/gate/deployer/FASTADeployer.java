 ...
 * 
 */
@Package(name = "FASTA", version = "3", archiveNameTemplate = "${lowerCaseName}${version}.shar.Z")
public class FASTADeployer extends AbstractCLDeployer {

    /**
     * 
     */
    public FASTADeployer() {
        super();
    }
    ...
    protected String getVersion() {
        return FASTADeployer.class.getAnnotation(Package.class).version();
    }
    ...
    protected String getPackageName() {
        return FASTADeployer.class.getAnnotation(Package.class).name();
    }
    ...
    protected String getArchiveTemplate() {
        return FASTADeployer.class.getAnnotation(Package.class).archiveNameTemplate();
    }
    ...
    protected String getSourceURL() {
        return FASTADeployer.class.getAnnotation(Package.class).sourceURL();
    }
