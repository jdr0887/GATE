 ...
 * 
 */
@Package(name = "BWA", version = "0.5.0", jobManagerType = JobManagerType.FORK)
public class BWADeployer extends AbstractCLDeployer {
    ...
    protected String getVersion() {
        return BWADeployer.class.getAnnotation(Package.class).version();
    }
    ...
    protected String getPackageName() {
        return BWADeployer.class.getAnnotation(Package.class).name();
    }
    ...
    protected String getArchiveTemplate() {
        return BWADeployer.class.getAnnotation(Package.class).archiveNameTemplate();
    }
    ...
    protected String getSourceURL() {
        return BWADeployer.class.getAnnotation(Package.class).sourceURL();
    }
