 ...
 * 
 */
@Package(name = "EMBOSS", version = "5.0.0", archiveNameTemplate = "${packageName}-${version}.tar.gz")
public class EMBOSSDeployer extends AbstractCLDeployer {

    /**
     * 
     */
    public EMBOSSDeployer() {
        super();
    }
    ...
    protected String getVersion() {
        return EMBOSSDeployer.class.getAnnotation(Package.class).version();
    }
    ...
    protected String getPackageName() {
        return EMBOSSDeployer.class.getAnnotation(Package.class).name();
    }
    ...
    protected String getArchiveTemplate() {
        return EMBOSSDeployer.class.getAnnotation(Package.class).archiveNameTemplate();
    }
    ...
    protected String getSourceURL() {
        return EMBOSSDeployer.class.getAnnotation(Package.class).sourceURL();
    }
