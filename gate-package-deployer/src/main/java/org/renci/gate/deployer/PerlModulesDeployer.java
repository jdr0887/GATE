 ...
 * 
 */
@Package(name = "PerlModules", version = "", archiveNameTemplate = "perl-modules.tar.gz")
public class PerlModulesDeployer extends AbstractCLDeployer {

    /**
     * 
     */
    public PerlModulesDeployer() {
        super();
    }
    ...
    protected String getVersion() {
        return PerlModulesDeployer.class.getAnnotation(Package.class).version();
    }
    ...
    protected String getPackageName() {
        return PerlModulesDeployer.class.getAnnotation(Package.class).name();
    }
    ...
    protected String getArchiveTemplate() {
        return PerlModulesDeployer.class.getAnnotation(Package.class).archiveNameTemplate();
    }
    ...
    protected String getSourceURL() {
        return PerlModulesDeployer.class.getAnnotation(Package.class).sourceURL();
    }
