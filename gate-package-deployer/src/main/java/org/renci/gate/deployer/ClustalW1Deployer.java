 ...
 * 
 */
@Package(name = "ClustalW1", version = "1.83")
public class ClustalW1Deployer extends AbstractCLDeployer {

    /**
     * 
     */
    public ClustalW1Deployer() {
        super();
    }
    ...
    protected String getVersion() {
        return ClustalW1Deployer.class.getAnnotation(Package.class).version();
    }
    ...
    protected String getPackageName() {
        return ClustalW1Deployer.class.getAnnotation(Package.class).name();
    }
    ...
    protected String getArchiveTemplate() {
        return ClustalW1Deployer.class.getAnnotation(Package.class).archiveNameTemplate();
    }
    ...
    protected String getSourceURL() {
        return ClustalW1Deployer.class.getAnnotation(Package.class).sourceURL();
    }
