 ...
 * 
 */
@Package(name = "RepeatMasker", version = "open-3-0-8", archiveNameTemplate = "${packageName}-${version}.tar.gz")
public class RepeatMaskerDeployer extends AbstractCLDeployer {

    /**
     * 
     */
    public RepeatMaskerDeployer() {
        super();
    }
    ...
    protected String getVersion() {
        return RepeatMaskerDeployer.class.getAnnotation(Package.class).version();
    }
    ...
    protected String getPackageName() {
        return RepeatMaskerDeployer.class.getAnnotation(Package.class).name();
    }
    ...
    protected String getArchiveTemplate() {
        return RepeatMaskerDeployer.class.getAnnotation(Package.class).archiveNameTemplate();
    }
    ...
    protected String getSourceURL() {
        return RepeatMaskerDeployer.class.getAnnotation(Package.class).sourceURL();
    }
