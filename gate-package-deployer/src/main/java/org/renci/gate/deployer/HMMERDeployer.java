 ...
 * 
 */
@Package(name = "Glimmer", version = "2.3.2")
public class HMMERDeployer extends AbstractCLDeployer {

    /**
     * 
     */
    public HMMERDeployer() {
        super();
    }
    ...
    protected String getVersion() {
        return HMMERDeployer.class.getAnnotation(Package.class).version();
    }
    ...
    protected String getPackageName() {
        return HMMERDeployer.class.getAnnotation(Package.class).name();
    }
    ...
    protected String getArchiveTemplate() {
        return HMMERDeployer.class.getAnnotation(Package.class).archiveNameTemplate();
    }
    ...
    protected String getSourceURL() {
        return HMMERDeployer.class.getAnnotation(Package.class).sourceURL();
    }
