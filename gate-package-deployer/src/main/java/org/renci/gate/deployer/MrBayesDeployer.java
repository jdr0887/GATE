 ...
 * 
 */
@Package(name = "MrBayes", version = "3.1.2")
public class MrBayesDeployer extends AbstractCLDeployer {

    /**
     * 
     */
    public MrBayesDeployer() {
        super();
    }
    ...
    protected String getVersion() {
        return MrBayesDeployer.class.getAnnotation(Package.class).version();
    }
    ...
    protected String getPackageName() {
        return MrBayesDeployer.class.getAnnotation(Package.class).name();
    }
    ...
    protected String getArchiveTemplate() {
        return MrBayesDeployer.class.getAnnotation(Package.class).archiveNameTemplate();
    }
    ...
    protected String getSourceURL() {
        return MrBayesDeployer.class.getAnnotation(Package.class).sourceURL();
    }
