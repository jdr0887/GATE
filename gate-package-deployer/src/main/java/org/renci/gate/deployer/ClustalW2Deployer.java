 ...
 * 
 */
@Package(name = "ClustalW2", version = "2.0.11", jobManagerType = JobManagerType.FORK)
public class ClustalW2Deployer extends AbstractCLDeployer {

    /**
     * 
     */
    public ClustalW2Deployer() {
        super();
    }
    ...
    protected String getVersion() {
        return ClustalW2Deployer.class.getAnnotation(Package.class).version();
    }
    ...
    protected String getPackageName() {
        return ClustalW2Deployer.class.getAnnotation(Package.class).name();
    }
    ...
    protected String getArchiveTemplate() {
        return ClustalW2Deployer.class.getAnnotation(Package.class).archiveNameTemplate();
    }
    ...
    protected String getSourceURL() {
        return ClustalW2Deployer.class.getAnnotation(Package.class).sourceURL();
    }
