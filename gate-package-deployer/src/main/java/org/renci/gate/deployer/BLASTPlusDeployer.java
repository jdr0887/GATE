 ...
 * 
 */
@Package(name = "BLASTPlus", version = "2.2.23+", jobManagerType = JobManagerType.FORK)
public class BLASTPlusDeployer extends AbstractCLDeployer {

    /**
     * 
     */
    public BLASTPlusDeployer() {
        super();
    }
    ...
    protected String getVersion() {
        return BLASTPlusDeployer.class.getAnnotation(Package.class).version();
    }
    ...
    protected String getPackageName() {
        return BLASTPlusDeployer.class.getAnnotation(Package.class).name();
    }
    ...
    protected String getArchiveTemplate() {
        return BLASTPlusDeployer.class.getAnnotation(Package.class).archiveNameTemplate();
    }
    ...
    protected String getSourceURL() {
        return BLASTPlusDeployer.class.getAnnotation(Package.class).sourceURL();
    }
